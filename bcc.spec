...
Source0  : https://github.com/iovisor/bcc/releases/download/v0.25.0/bcc-src-with-submodule.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667842247
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libbcc.so.0.25.0
/usr/lib64/libbcc_bpf.so.0
/usr/lib64/libbcc_bpf.so.0.25.0
