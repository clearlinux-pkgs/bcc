...
cd %{_builddir}
tar xf %{_sourcedir}/libbpf-0.0.5.tar.gz
cd %{_builddir}/bcc-0.11.0
mkdir -p src/cc/libbpf
cp -r %{_builddir}/libbpf-0.0.5/* %{_builddir}/bcc-0.11.0/src/cc/libbpf
%patch1 -p1
...
/usr/lib64/libbcc.so.0.12.0
/usr/lib64/libbcc_bpf.so.0
/usr/lib64/libbcc_bpf.so.0.12.0
