...
Version  : 0.13.0
Release  : 15
URL      : https://github.com/iovisor/bcc/archive/v0.13.0/bcc-0.13.0.tar.gz
Source0  : https://github.com/iovisor/bcc/archive/v0.13.0/bcc-0.13.0.tar.gz
Source1  : https://github.com/libbpf/libbpf/archive/v0.0.7/libbpf-0.0.7.tar.gz
...
%prep
%setup -q -n bcc-0.13.0
cd %{_builddir}
tar xf %{_sourcedir}/libbpf-0.0.7.tar.gz
cd %{_builddir}/bcc-0.13.0
mkdir -p src/cc/libbpf
cp -r %{_builddir}/libbpf-0.0.7/* %{_builddir}/bcc-0.13.0/src/cc/libbpf
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585750420
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/bcc-0.13.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/bcc/92170cdc034b2ff819323ff670d3b7266c8bffcd
cp %{_builddir}/libbpf-0.0.7/LICENSE.BSD-2-Clause %{buildroot}/usr/share/package-licenses/bcc/34c5034377edef1080538bd0d4f5cf9b78e22dff
cp %{_builddir}/libbpf-0.0.7/LICENSE.LPGL-2.1 %{buildroot}/usr/share/package-licenses/bcc/91c66db733cf0ff2b3216ec4223b940daf6b26d4
pushd clr-build
%make_install
popd
...
/usr/lib64/libbcc.so.0.13.0
/usr/lib64/libbcc_bpf.so.0
/usr/lib64/libbcc_bpf.so.0.13.0
