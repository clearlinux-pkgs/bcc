...
Version  : 0.10.0
Release  : 8
URL      : https://github.com/iovisor/bcc/archive/v0.10.0/bcc-0.10.0.tar.gz
Source0  : https://github.com/iovisor/bcc/archive/v0.10.0/bcc-0.10.0.tar.gz
Source1  : https://github.com/libbpf/libbpf/archive/v0.0.3/libbpf-0.0.3.tar.gz
...
%prep
%setup -q -n bcc-0.10.0
cd ..
%setup -q -T -D -n bcc-0.10.0 -b 1
mkdir -p src/cc/libbpf
cp -r %{_topdir}/BUILD/libbpf-0.0.3/* %{_topdir}/BUILD/bcc-0.10.0/src/cc/libbpf
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1565991685
mkdir -p clr-build
pushd clr-build
...
/usr/share/bcc/man/man8/deadlock_detector.8.gz
...
/usr/lib64/libbcc.so.0.10.0
/usr/lib64/libbcc_bpf.so.0
/usr/lib64/libbcc_bpf.so.0.10.0

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/bcc/LICENSE.txt
