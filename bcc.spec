...
Source0  : https://github.com/iovisor/bcc/releases/download/v0.31.0/bcc-src-with-submodule.tar.gz
...
Patch1: backport-fix-for-llvm-20.patch
Patch2: backport-fix-for-llvm-20-loadercc.patch
Patch3: backport-fix-for-llvm-20-debug.patch
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742323436
mkdir -p clr-build
pushd clr-build
...
-DENABLE_LLVM_SHARED=1  -G 'Unix Makefiles'
make  %{?_smp_mflags}
popd
pushd ../buildavx2/
...
cp %{_builddir}/bcc/libbpf-tools/bpftool/LICENSE %{buildroot}/usr/share/package-licenses/bcc/1a8626fdd1a6f6399717f401588a171fd99b2f5d || :
...
cp %{_builddir}/bcc/libbpf-tools/bpftool/libbpf/LICENSE.LGPL-2.1 %{buildroot}/usr/share/package-licenses/bcc/91c66db733cf0ff2b3216ec4223b940daf6b26d4 || :
cp %{_builddir}/bcc/src/cc/libbpf/LICENSE.BSD-2-Clause %{buildroot}/usr/share/package-licenses/bcc/419ec3c0b11c7d22472ea99c03c347413a4ea406 || :
cp %{_builddir}/bcc/src/cc/libbpf/LICENSE.LGPL-2.1 %{buildroot}/usr/share/package-licenses/bcc/91c66db733cf0ff2b3216ec4223b940daf6b26d4 || :
export GOAMD64=v2
pushd ../buildavx2/
GOAMD64=v3
pushd clr-build-avx2
...
%files data
%defattr(-,root,root,-)
/V3/usr/share/bcc/introspection/bps
...
/usr/share/bcc/man/man8/rdmaucma.8.gz
...
/usr/share/bcc/tools/doc/rdmaucma_example.txt
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libbcc.so.0.31.0
/V3/usr/lib64/libbcc_bpf.so.0.31.0
/usr/lib64/libbcc.so
/usr/lib64/libbcc.so.0
/usr/lib64/libbcc.so.0.31.0
/usr/lib64/libbcc_bpf.so
/usr/lib64/libbcc_bpf.so.0
/usr/lib64/libbcc_bpf.so.0.31.0

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/bcc/1a8626fdd1a6f6399717f401588a171fd99b2f5d
