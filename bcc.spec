...
%prep
%setup -q -n bcc-0.11.0
cd ..
%setup -q -T -D -n bcc-0.11.0 -b 1
mkdir -p src/cc/libbpf
cp -r %{_topdir}/BUILD/libbpf-0.0.5/* %{_topdir}/BUILD/bcc-0.11.0/src/cc/libbpf
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1571253201
mkdir -p clr-build
pushd clr-build
